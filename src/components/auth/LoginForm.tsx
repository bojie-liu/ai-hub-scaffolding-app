    ...
    <div className="flex items-center justify-center min-h-screen p-4 bg-gradient-to-br from-blue-50 to-indigo-100">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardDescription>登入以存取課程教案</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 p-3 bg-slate-50 rounded-lg text-xs text-muted-foreground space-y-1">
            <p className="font-medium text-slate-600">示範帳號：</p>
            <p>教師 — 帳號：teacher / 密碼：changeme</p>
            <p>學生 — 帳號：student / 密碼：student123</p>
          </div>
        </CardContent>
      </Card>
    </div>
