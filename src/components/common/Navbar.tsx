...
const navLinks = [
  ...
  { href: '/discussion', label: 'Discuss', icon: MessageSquare, hideForGuest: true },
      ...
      <div className="max-w-7xl mx-auto px-4 flex items-center justify-between h-16">
        <div className="flex items-center gap-6">
          <Link href="/lesson" className="flex items-center gap-2 shrink-0">
            <span className="w-8 h-8 rounded-lg bg-indigo-600 flex items-center justify-center text-white font-bold text-sm">CT</span>
            <span className="font-semibold text-slate-800 text-sm hidden sm:block">Constructivism Theory</span>
          </Link>
